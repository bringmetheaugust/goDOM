...
var (
	// mock DOM for "./test/test.html" file
	mockDOM = Document{
		Title:   &mockEl_title_1.TextContent,
		Body:    mockEl_body_0,
		Head:    mockEl_header_0,
		Doctype: html5,
		Links:   []*Element{mockEl_a_0, mockEl_a_1},
	...
	mockEl_body_0 = &Element{
		...
		ClassList:   nil,
		Id:          "",
		Children:    children{mockEl_header_0, mockEl_main_1, mockEl_footer_0},
	}
	...
	mockEl_nav_1 = &Element{
		...
		ClassList:   nil,
		Id:          "",
		Children:    children{mockEl_h3_1, mockEl_ul_1, mockEl_a_0},
	}
	mockEl_h3_1 = &Element{
		TagName:     "h3",
	...
	mockEl_a_0 = &Element{
		...
		Attributes:  attributes{"href": "heaven"},
		ClassName:   "",
		ClassList:   nil,
		Id:          "",
		Children:    nil,
	...
	mockEl_div_2 = &Element{
		...
		ClassList:   nil,
		Id:          "",
		Children:    children{mockEl_address_0, mockEl_img_1, mockEl_address_1, mockEl_a_1},
	}
	...
	mockEl_a_1 = &Element{
		...
		Attributes:  attributes{"href": "hell"},
		ClassName:   "",
		ClassList:   nil,
		Id:          "",
		Children:    nil,
	}
	mockEl_footer_0 = &Element{
		TagName:     "footer",
		TextContent: "",
		Attributes:  nil,
		ClassName:   "",
...
// This fields cann't set in variables above cause it makes circular dependencies.
func buildMockElement(e *Element) *Element {
	for i, c := range e.Children {
		c.ParentElement = e

		if i != 0 {
			c.PreviousElementSibling = e.Children[i-1]
		}

		if i != len(e.Children)-1 {
			c.NextElementSibling = e.Children[i+1]
		}
